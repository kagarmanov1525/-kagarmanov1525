...
|----------------|-----------------|-----|
|Консультативное задание. **Построение модели**  (__[github]()__)| | |
...
|Практика SQL. **Ответить на вопросы. Собрать датасет**  (__[github]()__)| | |
